...
root = Tk()  #creating tinker window
...
#-----------------INFO TOP------------
lblinfo = Label(Tops, font=( 'timesnewroman' ,30, 'bold' ),text="Restaurant Management System",fg="steel blue",bd=10,anchor=W)
lblinfo.grid(row=0,column=0)
lblinfo = Label(Tops, font=( 'timesnewroman' ,20, ),text=localtime,fg="steel blue",anchor=W)
...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="-By CK and Team",bd=2,relief=SUNKEN)
